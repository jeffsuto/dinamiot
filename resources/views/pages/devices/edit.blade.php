    ...
    <div class="card bg-grey bg-lighten-4">
        <div class="card-body collapse in">
            <div class="card-block">
                ...
                <form class="form" action="{{ route('web.devices.update', $device->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="form-body">
                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ $device->name }}" class="form-control" placeholder="Device name" name="name" required>
                                </div>
                            </div>
                            <div class="col-md-6 col-sm-6">
                                <div class="form-group">
                                    <label>Serial Number</label>
                                    <input type="text" value="{{ $device->serial_number }}" class="form-control" placeholder="Serial Number" name="serial_number" required>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6 col-sm-6">
                                <div class="form-group">
                                    ...
                                    <textarea name="description" class="form-control" cols="30" rows="3">{{ $device->description }}</textarea>
                                </div>
                            </div>
                            <div class="col-md-6 col-sm-6">
                                <div class="form-group">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-3 col-sm-12">
                                            ...
                                            <input type="text" value="{{ $component->name }}" class="form-control" placeholder="eg. Temperature" name="component_name[]">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-md-2 col-sm-12">
                                            ...
                                            <select name="component_type[]" class="form-control" required>
                                                ...
                                                <option value="analog" {{ ($component->type == "analog" ? "selected":"") }}>Analog Input</option>
                                                <option value="digital" {{ ($component->type == "digital" ? "selected":"")}}>Digital Input</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-md-2 col-sm-12">
                                            ...
                                            <input type="number" value="{{ $component->min_value }}" class="form-control component-min-value" placeholder="min. value" name="component_min_value[]">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-md-2 col-sm-12">
                                            <label>Max. Value <span class="text-muted">(Optional)</span></label>
                                            <input type="number" value="{{ $component->max_value }}" class="form-control" placeholder="max. value" name="component_max_value[]">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-md-2 col-sm-12">
                                            <label>Unit Value <span class="text-muted">(Optional)</span></label>
                                            <input type="text" value="{{ $component->unit }}" class="form-control" placeholder="eg. F" name="component_unit[]">
                                        </div>
                                    </div>
                                    @if ($loop->index != 0)
                                        <div class="form-group">
                                            <div class="col-md-1 col-sm-12">
                                                <label class="grey lighten-4">Remove</label>
                                                <button type="button" class="btn btn-danger form-control remove-button-alert">
                            ...
                            <div class="col-md-5 col-sm-5">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
										<input type="number" value="{{ $device->endpoint->request_interval }}" class="form-control" placeholder="500" name="request_interval">
...
@push('script')
    <script>
        ...
        $(document).ready(function(){
            ...
            // show alert before removing component button that has value
            $(wrapper).on('click', '.remove-button-alert', function(e){
                swal({
                    title: "Are you sure?",
                    text: "Once deleted, your component data will be deleted!",
                    icon: "warning",
                    buttons: true,
                    dangerMode: true,
                })
