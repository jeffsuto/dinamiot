    ...
    <div class="navbar-wrapper">
        <div class="navbar-header">
            <ul class="nav navbar-nav">
                ...
                <li class="nav-item">
                    <a href="{{ route('web.dashboard.index') }}" class="navbar-brand nav-link">
                        <img alt="branding logo" style="max-height: 30px" src="{{ asset('assets/images/dinamiot-full.svg') }}" 
                        data-expand="{{ asset('assets/images/dinamiot-full.svg') }}" data-collapse="{{ asset('assets/images/dinamiot-single.svg') }}" 
                        class="brand-logo">
                    </a>
                </li>
                <li class="nav-item hidden-md-up float-xs-right">
                    ...
                    <a href="#" data-toggle="dropdown" class="nav-link nav-link-label pt-1">
